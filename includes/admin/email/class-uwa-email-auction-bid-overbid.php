        ...
        public function trigger( $outbiddeduser, $product ) {
            ...
            if($outbiddeduser > 0){
                ...
                if(is_object($user->data)){
                    ...
                    $this->object['user_email'] = $user->data->user_email;
                    $this->object['user_name'] = $user->data->user_login;
                    
                    if(is_object($product)){                        
                        $this->object['product_name'] = $product->get_title();
                        $this->object['url_product'] = get_permalink($product->get_id());
                ...
                } /* end of if - is object user-data */

            } /* end of if - outbiddeduser */

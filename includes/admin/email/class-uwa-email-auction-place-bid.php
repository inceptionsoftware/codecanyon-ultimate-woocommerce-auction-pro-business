...
if ( ! class_exists( 'UWA_Email_Place_Bid' ) ) {
    ...
    class UWA_Email_Place_Bid extends WC_Email {
        ...
        public function __construct() {
            ...
            $this->description = __('Email Notification sent to bidder when Bidder places a bid.', 'woo_ua');      
        ...
        public function init_form_fields() {
            $this->form_fields = array(
                ...
                'subject'    => array(
                    ...
                    'type'        => 'text',
                    'description' => sprintf( __( 'Enter the subject of the email that is sent to the bidder after successfully placing a bid.Leave blank to use the default subject:- <code>%s</code>.', 'woo_ua' ), esc_html( $this->subject ) ),
                    'placeholder' => '',
                    'default'     => '',
                    'desc_tip'    => true
                ),

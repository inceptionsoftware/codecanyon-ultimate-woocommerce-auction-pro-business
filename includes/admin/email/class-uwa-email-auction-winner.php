...
if ( !class_exists( 'UWA_Email_Auction_Winner' ) ) { 
    ...
    class UWA_Email_Auction_Winner extends WC_Email {   
        ...
        public function __construct() {
            ...
            $this->description = __( 'Email Can be sent to the bidder after winning an auction', 'woo_ua' );
            ...
            add_action( 'woo_ua_auctions_won_email_bidder', 
        ...
        public function trigger($product_id, $winneruser) {
            ...
            $recipients2 = array();
                ...
                if ( count( $recipients2 ) > 0 ) {
                    ...
                    $this->send( $value, $this->get_subject(), $this->get_content(),
